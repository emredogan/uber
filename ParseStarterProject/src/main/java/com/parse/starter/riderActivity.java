...
public class riderActivity extends FragmentActivity implements OnMapReadyCallback {
                                    ...
                                    if(lastKnownLocation != null) {
                                        ...
                                        if(driverLocation != null) {
                                            ...
                                            if (distanceInMiles < 0.01) {
                                                ...
                                                infoTextView.setText("Driver has arrived");
                                                ...
                                                markers.add(mMap.addMarker(new MarkerOptions().position(requestLocationLatLng).title("Request Location").icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_ORANGE))));
    ...
    public void callUber(View view) {
        Log.i("Info", requestActive.toString());
