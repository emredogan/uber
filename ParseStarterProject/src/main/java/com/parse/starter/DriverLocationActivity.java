                            ...
                            object.saveInBackground(new SaveCallback() {
                                ...
                                public void done(ParseException e) {
                                    if (e==null) {
                                        ...
                                        Double driverLong = intent.getDoubleExtra("driverLongitude", 0);

                                        Double requestLat = intent.getDoubleExtra("requestLatitude", 0);
                                        Double requestLong = intent.getDoubleExtra("requestLongitude", 0);
                                        ...
                                        Log.i("driverLat", Double.toString(driverLat));
                                        Log.i("driverLong", Double.toString(driverLong));
                                        Log.i("requestLat", Double.toString(requestLat));
                                        Log.i("requestLong", Double.toString(requestLong));
                                    }
                                }
                            });
                        }
